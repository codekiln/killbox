...
The prototype map SHALL include two enemy entrances, two waypoint paths, one merge point, and one defended objective.
...
- **WHEN** the developer inspects the waypoint placeholders
...
- **GIVEN** the prototype scene is open
- **WHEN** the developer inspects the arena
